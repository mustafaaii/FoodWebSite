...
import Carousel from "./assets/featured_js/FeaturedCarousuel";
import "./assets/featured_css/FeaturedCarousuel.css";
import { Card, Col, Row } from 'react-bootstrap';
import Image01 from "./assets/featured_img/img01.svg"
import Stars from "./assets/featured_img/icons/stars.svg"
import Price from "./assets/featured_img/icons/price.svg"
import Location from "./assets/featured_img/icons/location.svg"
import Time from "./assets/featured_img/icons/time.svg"

export default function featured() {
    return (
        <>
        <div className="featured-card-content">
            <h3 className="BodySectionTittle" style={{marginLeft:"-35px"}}>Featured</h3>
